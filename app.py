    ...
    if not api_key:
        ...
        with st.spinner(f"Sedang merancang RPP untuk {waktu} pertemuan... Mohon tunggu sekitar 15-20 detik."):
            try:
                ...
                - 5. Asesmen Sumatif (20 oal pilihan ganda HOTS dengan 5 obsi jawaban, 10 soal isian singkat dan 5 soal uraian beserta Kunci Jawaban sesuai dengan KKTP yang telah ditentukan).
