...
st.title("⛪ Generator Modul Ajar Pendidikan Agama Katolik SMA/SMK")
...
sekolah = st.sidebar.text_input("Nama Sekolah:", "SMK Negeri 2 Metro")
...
with col2:
    ...
    waktu = st.number_input("Jumlah Pertemuan (1 Pertemuan = 135 Menit):", min_value=1, max_value=10, value=2)
    ...
    if not api_key:
        ...
        with st.spinner(f"Sedang merancang RPP untuk {waktu} pertemuan... Mohon tunggu sekitar 15-20 detik."):
            try:
                ...
                prompt_text = f"""
                saya adalah guru pendidikan agama katolik jenjang Sekolah Menengah Atas, Buatkan Rencana Pelaksanaan Pembelajaran (RPP) / Modul Ajar berbasis Pembelajaran Mendalam (Deep Learning) secara LENGKAP untuk {waktu} pertemuan. rancangan pembelajaran harus sesuai dengan tahapan belajar perkembangan anak usia sekolah Menengah Atas, buat bahasa yang sederhana dan mudah dipahami oleh anak  usia sekolah Menehah Atas.
                ...
                Setiap 1 pertemuan terdiri dari 135 menit. Bagi waktu di setiap pertemuan agar sesuai dengan kegiatan awal, kegiatan inti, dan penutup. gunakan rumusan Dimensi Profil Lulusan bukan Dimensi profil Pelajar pancasila
                ...
                - 5. Asesmen Sumatif (20 oal pilihan ganda HOTS dengan 5 pilihan jawaban a,b,c,d,e. 10 soal isian singkat dan 5 soal uraian beserta Kunci Jawaban sesuai dengan KKTP yang telah ditentukan).
